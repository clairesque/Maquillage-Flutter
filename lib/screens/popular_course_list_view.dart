...
class _PopularCourseListViewState extends State<PopularCourseListView>
  ...
  Future<List<ProductModel>> popularCourseList = Api.getProductList();
                      ...
                      Navigator.push<dynamic>(
                        ...
                        MaterialPageRoute<dynamic>(
                          builder: (BuildContext context) =>
                              CourseInfoScreen(product: products[index]),
                        ),
                      );
                    },
                  );
          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1.2,
                  child: Image.network(product.imageLink, errorBuilder:
