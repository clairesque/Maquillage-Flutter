...
class _HomeScreenState extends State<Home> {
  CategoryType categoryType = CategoryType.one;
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            children: <Widget>[
              getButtonUI(CategoryType.one, categoryType == CategoryType.one),
              const SizedBox(
                width: 16,
              ),
              getButtonUI(
                  CategoryType.two, categoryType == CategoryType.two),
              const SizedBox(
                width: 16,
              ),
              getButtonUI(
  ...
  Widget getButtonUI(CategoryType categoryTypeData, bool isSelected) {
    String txt = '';
    if (CategoryType.one == categoryTypeData) {
      txt = 'Organic';
